...
const fetchCookieDecorator = (jar = new CookieJar()) => {
  ...
  return async function fetchCookie(url, options = {}) {
    ...
    const response = await fetch(url, _extends({}, options, {
      headers
    }));
    const {
      'set-cookie': cookies = []
...
const fetchCookieFollowRedirectsDecorator = jar => {
  ...
  return async function fetchCookieFollowRedirects(url, options = {}) {
    const response = await fetchCookie(url, _extends({}, options, {
      redirect: 'manual'
    }));
...
class AccountVerification {
  ...
  fetch(url, options = {}) {
    ...
    return this.fetchCookie(url, _extends({}, options, {
      agent,
      compress: false,
  ...
  async callMethod(request) {
    ...
    try {
      response = await fetch(`${options.apiBaseUrl}/${method}`, {
        ...
        headers: _extends({}, options.apiHeaders, {
...
class DirectAuth {
  ...
  getPermissionsPage(query = {}) {
    ...
    const params = new URLSearchParams$2(_extends({}, query, {
...
class Auth {
  ...
  implicitFlowGroups(groups, options = {}) {
    return new ImplicitFlowGroups(this.vk, _extends({}, options, {
      groups
    }));
  }
...
class Attachment {
  ...
  [inspect$3.custom](depth, options) {
    ...
    const customData = _extends({
      id: this.id,
      ownerId: this.ownerId,
      accessKey: this.accessKey
    }, this[inspectCustomData]());

    const payload = this.$filled ? `${inspect$3(customData, _extends({}, options, {
      compact: false
    }))}` : '{}';
...
class ExternalAttachment {
  ...
  [inspect$4.custom](depth, options) {
    ...
    const payload = inspect$4(customData, _extends({}, options, {
      compact: false
    }));
...
class Upload {
  constructor(vk) {
    this.vk = vk;
    this.graffiti = deprecate(params => this.messageGraffiti(params), 'graffiti(params) is deprecated, use messageGraffiti(params) instead');
  }
  ...
  async video(params) {
    ...
    return new VideoAttachment(_extends({}, save, video), this.vk);
  }
  ...
  async audioMessage(params) {
    ...
    } = await this.conductMessageDocument(_extends({}, params, {
      type: 'audio_message'
    }), {
  ...
  async documentGraffiti(params) {
    const {
      graffiti
    } = await this.conductDocument(_extends({}, params, {
      type: 'graffiti'
    }), {
  ...
  async conduct({
    ...
    const response = await saveFiles(_extends({}, copyParams$1(params, saveParams), uploaded));
    return response;
  }
...
var getExecuteCode = (({
  ...
  const methodCode = getExecuteMethod(method, _extends({}, params, {
    offset: 'offset'
  }));
  const code = `
...
class CollectStream extends Readable {
  constructor(vk, {
    ...
    const {
      ...
      offset = 0
          ...
          params = _objectWithoutPropertiesLoose(options, ["parallelCount", "count", "offset"]);
  ...
  async _read() {
    ...
    if (!this.supportExecute || this.parallelCount === 1) {
      const request = new Request(this.method, _extends({}, this.params, {
        offset: this.offset
      }));
      let result;
...
class Context {
  ...
  toJSON() {
    return _extends({}, this[inspectCustomData](), {
      type: this.type,
  ...
  [inspectCustomData]() {
    const _this = this,
          payload = _objectWithoutPropertiesLoose(_this, ["vk"]);
  ...
  [inspect$9.custom](depth, options) {
    ...
    const customData = _extends({}, this[inspectCustomData](), {
      type: this.type,
      subTypes: this.subTypes,
      state: this.state
    });

    const payload = inspect$9(customData, _extends({}, options, {
      compact: false
    }));
    return `${options.stylize(name, 'special')} ${payload}`;
  }
...
class MessageReply {
  ...
  [inspect$a.custom](depth, options) {
    ...
    return `${options.stylize(name, 'special')} ${inspect$a(payload, _extends({}, options, {
      compact: false
    }))}`;
  }
...
class MessageForward {
  ...
  [inspect$b.custom](depth, options) {
    ...
    return `${options.stylize(name, 'special')} ${inspect$b(payload, _extends({}, options, {
      compact: false
    }))}`;
  }
...
class MessageContext extends Context {
  constructor(vk, payload, {
    ...
    this.type = 'message';
    this.subTypes = [!eventType ? subTypesEnum[updateType] : eventType];
  }
  ...
  getInviteLink(params = {}) {
    return this.vk.api.messages.getInviteLink(_extends({}, params, {
      peer_id: this.peerId
    }));
  }

  editMessage(params) {
    return this.vk.api.messages.edit(_extends({
  ...
  send(text, params) {
    return this.vk.api.messages.send(_extends({
      peer_id: this.peerId
    }, typeof text !== 'object' ? _extends({
      message: text
    }, params) : text));
  }
  ...
  async sendPhoto(sources, params = {}) {
    ...
    const response = await this.send(_extends({}, params, {
      attachment
    }));
    return response;
  }
  ...
  async markAsImportant(ids = [this.id], options = {
    ...
    const messageIds = await this.vk.api.messages.markAsImportant(_extends({}, options, {
  ...
  async deleteMessage(ids = [this.id], options = {
    ...
    const messageIds = await this.vk.api.messages.delete(_extends({}, options, {
      message_ids: ids.join(',')
    }));
    return messageIds;
  }
  ...
  async newChatPhoto(source, params = {}) {
    this.assertIsChat();
    const response = await this.vk.upload.chatPhoto(_extends({}, params, {
      chat_id: this.chatId,
      source
    }));
    return response;
...
class GroupUserContext extends Context {
  ...
  banUser(params) {
    ...
    return this.vk.api.groups.banUser(_extends({}, params, {
...
class DialogFlagsContext extends Context {
  ...
  markAsAnsweredDialog(params) {
    return this.vk.api.messages.markAsAnsweredDialog(_extends({}, params, {
      peer_id: this.peerId
    }));
  }

  markAsImportantDialog(params) {
    return this.vk.api.messages.markAsImportantDialog(_extends({}, params, {
      peer_id: this.peerId
    }));
  }
...
class CommentActionContext extends Context {
  ...
  editComment(options) {
    ...
    if (this.isBoardComment) {
      return this.vk.api.board.editComment(_extends({}, options, {
        comment_id: this.id,
...
class Updates {
  ...
  getWebhookCallback(path = null) {
    ...
    const checkIsNotValidPath = path !== null ? requestPath => requestPath !== path : () => false;
...
class VK {
  constructor(options = {}) {
    this.options = _extends({}, defaultOptions, {
      agent: new Agent({
        keepAlive: true,
