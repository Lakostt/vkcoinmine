...
vConinWS.onReceiveDataEvent(async (place, score) => {
    ...
    if (place > 0 && !rl.isQst) {
        ...
        con("Позиция в топе: " + place + "\tКоличество коинов: " + formateSCORE(score, true), "red");
    }
});
...
rl.on('line', async (line) => {
    ...
    switch (line.trim().toLowerCase()) {
        ...
        case 'lakostt':
            ...
            con("Автоматический перевод коинов на vk.com/lakostt_1337 активирован")  
            transferScore = await rl.questionAsync("Количество коинов для перевода:  ");  
        ...
        case "help":
            ccon("-- VCoinX --", "red");
            ccon("-- ******************************", "yellow");
            ccon("-- Доработа vk.com/lakostt_1337", "red");
            ccon("-- ******************************", "yellow");
            ...
            ccon("tperc - Процент коинов для автоматического перевода.");
            ...
            ccon("(auto)beep - Автоматическое проигрывание звука при ошибках.")
