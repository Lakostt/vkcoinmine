# VCoinX
VCoinX - модификация для [VCoin], в которой вырезаны пожертвования и комиссии от платежей, а так-же она имеет несколько своих плюшек.
...
* [Lakostt] (https://github.com/Lakostt) - сторонний разработчик. Добавил улучшение функционала, дизайна. Оптимизация кода
